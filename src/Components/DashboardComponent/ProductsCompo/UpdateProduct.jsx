...
const UpdateProduct = ({ product }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    fetch("https://panchahut-server.vercel.app/api/v1/product/update", {
      method: "POST",
      headers: {
  ...
  return (
    <dialog id={`my_modal_up${product?._id}`} className="modal  fixed">
      <div className="modal-box w-11/12 max-w-5xl ">
        <div className=" flex justify-end">
          <form method="dialog">
            <button className="font-bold text-xl text-red-600">X</button>
          </form>
        </div>
        <div className="">
          <div className="   ">
